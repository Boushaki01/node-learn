...
function Form({ mode = 'create' }) {
  ...
  const title = mode === 'create' ? 'Tambah Peserta' : mode === 'edit' ? 'Edit Peserta' : 'Detail Peserta';
    ...
    <div className="p-6 max-w-xl mx-auto">
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <Input name="name" value={form.name} onChange={handleChange} placeholder="Nama Peserta" required readOnly={isReadOnly} />
          <select name="status" value={form.status} onChange={handleChange} disabled={isReadOnly} className="p-2 borded rounded">
